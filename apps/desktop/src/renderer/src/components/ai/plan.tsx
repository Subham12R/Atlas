...
const usePlan = (): PlanContextValue => {
...
export const PlanTitle = ({ children, className, ...props }: PlanTitleProps) => {
  ...
  return (
    <CardTitle
      className={cn(isStreaming && 'shimmer-text', className)}
...
export const PlanTrigger = ({ className, ...props }: PlanTriggerProps) => (
  <CollapsibleTrigger
    className={cn(
      'flex size-7 items-center justify-center rounded-md text-[#6E6D6A] dark:text-[#9E9D9A] transition-colors hover:bg-[#F1EFEA] dark:hover:bg-[#2C2C2A] hover:text-[#2E2E2D] dark:hover:text-[#EAE8E3] cursor-pointer',
      className
    )}
